...
/// <summary>
/// Extends the default SignInManager to block inactive users
/// from signing in, regardless of correct password.
/// </summary>
public class CustomSignInManager : SignInManager<ApplicationUser>
{
        ...
        bool   lockoutOnFailure)
    {
        ...
        {
            // Return a failed result without a lockout increment
